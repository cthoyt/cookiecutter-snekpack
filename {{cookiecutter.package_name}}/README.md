...
https://zenodo.org/account/settings/github/repository/{{cookiecutter.github_organization_name}}/{{cookiecutter.github_repository_name}}
...
1. Navigate to
   https://github.com/{{cookiecutter.github_organization_name}}/{{cookiecutter.github_repository_name}}/releases/new
